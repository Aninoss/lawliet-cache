 ...
 */
public class CustomSearchedIllusts {

  @SerializedName("illusts")
  private List<CustomIllustration> illusts = new ArrayList<>();
   ...
   **/
  public List<CustomIllustration> getIllusts() {
    return illusts;
  }
   ...
   */
  public void setIllusts(List<CustomIllustration> illusts) {
  ...
  public boolean equals(Object o) {
    ...
    CustomSearchedIllusts that = (CustomSearchedIllusts) o;
